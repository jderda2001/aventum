...
const LeadForm = () => {
  ...
  return (
    <motion.section 
      className="w-full px-6 md:px-8 py-12 flex justify-center"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        {!isSuccess ? (
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {isSubmitting ? (
                  <div className="h-5 w-5 rounded-full border-2 border-aventum-navy border-t-transparent animate-spin"></div>
                ) : (
                  <>
          ...
          <motion.div 
            className="glass rounded-xl p-8 w-full text-center"
          ...
          >
            <div className="flex flex-col items-center justify-center space-y-4">
              ...
              <button
                ...
                className="text-aventum-gold hover:underline mt-4"
              >
